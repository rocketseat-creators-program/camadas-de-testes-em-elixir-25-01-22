...
config :ectestes,
  ecto_repos: [Ectestes.Repo],
  generators: [binary_id: true]

# Configures the endpoint
config :ectestes, EctestesWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: EctestesWeb.ErrorView, accepts: ~w(html json), layout: false],
...
config :ectestes, Ectestes.Mailer, adapter: Swoosh.Adapters.Local
